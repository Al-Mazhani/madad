    ...
    <section class="container">
        ...
        <div class="book_results">
            <div class="result-books" title="الأشهر اليوم">
                <a href="">
                    <img src="public/images/trend_books2.svg" alt="الأشهر اليوم"  loading="lazy">
                    <p> الأشهر اليوم</p>
                </a>
            </div>
            <div class="result-books" title="أشهر الكتب">
                <a href="">
                    <img src="public/images/best_books_all_days1.svg" alt="أشهر اليوم"  loading="lazy">
                    <p>أشهر الكتب</p>
                </a>
            </div>
            <div class="result-books" title="أحدث الكتب">
                <a href="">
                    <img src="public/images/new_books1.svg" alt=" أحدث الكتب"  loading="lazy">
                    <p> أحدث الكتب</p>
                </a>
            </div>
        </div>
